...
# 讀取 node1 的私鑰
PRIVATE_KEY = os.getenv("NODE5_PRIVATE_KEY")

if PRIVATE_KEY is None:
    raise Exception("NODE5_PRIVATE_KEY not found in .env")
...
while True:
    try:
        ...
        print("Node5 Current state:", state)
...
# 🔐 簽章
        ...
        submission = {
            ...
            "address": "0xE9d2ADD1A04857395648a11b6042aDC5C5b4774d"
        }
